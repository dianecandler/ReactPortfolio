				...
				<div className='row mx-0'>
					<div className='col-md-6 col-lg-4  pl-0 pr-md-30px'>
						...
						<p className='mt-4'>
							...
							<br />
							<a href='mailto://dianedcandler@gmail.com'>
					...
					<div className='col-md-6 col-lg-4 order-md-2  order-lg-3  mt-5 mt-lg-0 px-0'>
						<strong className='text-uppercase text-dark'>My Bio</strong>
						<br />
						<p className='mt-4'>
							Raised in a family of well educated, high achievers, Diane
							instinctly developed a passion for learning. She began her career
							in product management and marketing before starting her own
							creative services business. Today she desires to join a company
							that values her experience and newly acquired full-stack coding
							skills.
						</p>
						<div className='mt-4'>
							<img
								src='/img/Diane_Square.jpg'
								alt='Diane Candler'
								height='200'
					...
					<div className='row mx-0'>
						...
						<div className='col-md-6 col-lg-4 pl-0 pr-md-30px mt-5 mt-md-0'>
							...
							<ul className='social-icons d-none d-sm-block'>
								<li>
									<a href='https://github.com/dianecandler' target='_blank'>
								...
								<li>
									<a
										href='https://www.linkedin.com/in/diane-candler-centraltexas/'
										target='_blank'
									>
